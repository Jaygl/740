...
testingMode = False # suppresses figure generation, 
                    # outputs from main*.py are not printed
...
percentFixedRandomObstacles = 10
safetymargin = 1
...
goals = np.array([[18., 28., 6., 0.]])  * mapscale # goal coordinates
